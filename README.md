...
Decentralized coordination: No central authority needed; agents operate at neighborhood scale
Leverages existing IoT: Works with smart meters DISCOMs already deploying
Economics-first: DISCOM saves ₹5/kWh vs. ₹50/kWh peaking power → ROI justifies investment
Indian Context:
...
Build the prototype (FastAPI + React)
Create UX mockups (Figma)
Write detailed business model (unit economics)
Generate metrics (simulation runs)
Final submission + video (by Nov 22)
...
Team composition: How many people? Who leads write-up vs. diagram?
Tech stack decision: Confirm FastAPI + React (or alternative)?
Data source: Will you use IITB data, Kaggle, or synthetic in Phase 2?
Problem angle: Is it "neighborhood coordination" or "forecasting + storage" or "demand response"? Be clear.
